 ...
 <?php
  ...
  <li class="nav-item " style="padding-top: 0px; margin-top: 0px;">
    <a class="nav-link" style="padding-top: 0px;">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="?page=forecasting">
          <i class="fas fa-fw fa-home"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         if ($page == "forecasting") {
          if ($aksi == "") {
            include "page/forecasting/forecasting.php";
          }
           if ($aksi == "tambahsupplier") {
            include "page//forecasting/tambahsupplier.php";
          }
           if ($aksi == "ubahsupplier") {
            include "page/forecasting/ubahsupplier.php";
          }
          
           if ($aksi == "hapussupplier") {
            include "page/forecasting/hapussupplier.php";
          }
        }
