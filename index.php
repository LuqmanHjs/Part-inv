...
<?php
  ...
  // $timeout = 1; //menit
	// $timeout = $timeout * 20; //detik

  // if (isset($_SESSION['start_session'])){
  //   $elapsedtime = time() - $_SESSION['start_session'];
  //   if($elapsedtime >= $timeout){
  //     session_destroy();
  //     echo " <script type='text/javascript'>alert('Sesi Berakhir'); window.location='logout.php'
  //     </script>";
  //   }
  // }
